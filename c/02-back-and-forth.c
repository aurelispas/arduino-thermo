 ...
 *
 *   ruby 02-back-and-forth.rb
 *
 * Hints:
 *
 * - To create a pause in your loop, consider using usleep. See:
 *
 *     man 3 usleep
 *
 ...
 *     man 3 fflush
 *
 * - The Control-M character (0x08) moves the cursor to the beginning of the
 *   line.
 *
 * Comple & run with:
 *
